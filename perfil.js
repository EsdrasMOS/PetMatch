    ...
    // Atualiza todos os usuários no localStorage
    ...
    function confirmDeleteAccount() {
        if (confirm("⚠️ Você tem certeza que deseja excluir sua conta? Essa ação não pode ser desfeita.")) {
            deleteAccount();
        }
    }
    ...
    function deleteAccount() {
        ...
        // Remove os favoritos do usuário
